...
export const ERROR_POLICIES = Object.freeze({
  ...
  CANDIDATE_HASH_MISMATCH: policy(422),
  CHECKLIST_NOT_FOUND: policy(404),
  CHECKLIST_TASK_MISMATCH: policy(409),
  ...
  PROJECT_RESTORE_REQUEST_DECIDED: policy(409),
  PROJECT_RESTORE_REQUEST_NOT_FOUND: policy(404),
