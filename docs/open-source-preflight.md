...
| Visual assets             | Pass       | The tracked logo and Windows icon are original project artwork supplied by the maintainer. See [`asset-provenance.md`](./asset-provenance.md).                                                                                                                                                                                                                                                                |
