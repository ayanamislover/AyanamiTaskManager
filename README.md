...
桌面端同步改进设置布局、项目顺序和工程统计扫描。查看[本轮反馈与处理边界](./docs/agent-feedback-2026-09.md)。正式发布状态以 [GitHub Release](https://github.com/ayanamislover/AyanamiTaskManager/releases) 为准。
